...
typedef enum {
  ...
  REG_NVM_SUBSYSTEM_RESET = 0x20,    // 32
  REG_ADMIN_QUEUE_ATTRIBUTE = 0x24,  // 36
  REG_ADMIN_SQUEUE_BASE_ADDR = 0x28, // 40
  REG_ADMIN_CQUEUE_BASE_ADDR = 0x30, // 48
  REG_CMB_LOCATION = 0x38,           // 56
  REG_CMB_SIZE = 0x3C,
