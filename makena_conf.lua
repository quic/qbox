...
-- hexagon_0 = { gdb_port = 1234 };
    ...
    -- FIXME these will need to move to the appropriate location:
    l2vic={  mem           = {address=UNLIKELY_TO_BE_USED+0xfc910000, size=0x1000};
             fastmem       = {address=UNLIKELY_TO_BE_USED+0xd81e0000, size=0x10000}};
    qtimer={ mem           = {address=UNLIKELY_TO_BE_USED+0xfab20000, size=0x1000};
             timer0_mem    = {address=UNLIKELY_TO_BE_USED+0xfc921000, size=0x1000};
             timer1_mem    = {address=UNLIKELY_TO_BE_USED+0xfc922000, size=0x1000}};
