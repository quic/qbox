...
static void object_property_set_str_worker(void *opaque) {
  struct object_property_set_str_params *params =
      (struct object_property_set_str_params *)opaque;
  object_property_set_str(params->p0, params->p1, params->p2, params->p3);
}

void object_property_set_str_wrapper(Object *p0, const char *p1, const char *p2,
                                     Error **p3) {
  struct object_property_set_str_params params;
...
static void object_property_set_link_worker(void *opaque) {
  struct object_property_set_link_params *params =
      (struct object_property_set_link_params *)opaque;
  object_property_set_link(params->p0, params->p1, params->p2, params->p3);
}

void object_property_set_link_wrapper(Object *p0, const char *p1, Object *p2,
                                      Error **p3) {
  struct object_property_set_link_params params;
...
static void object_property_set_bool_worker(void *opaque) {
  struct object_property_set_bool_params *params =
      (struct object_property_set_bool_params *)opaque;
  object_property_set_bool(params->p0, params->p1, params->p2, params->p3);
}

void object_property_set_bool_wrapper(Object *p0, const char *p1, bool p2,
                                      Error **p3) {
  struct object_property_set_bool_params params;
...
static void object_property_set_int_worker(void *opaque) {
  struct object_property_set_int_params *params =
      (struct object_property_set_int_params *)opaque;
  object_property_set_int(params->p0, params->p1, params->p2, params->p3);
}

void object_property_set_int_wrapper(Object *p0, const char *p1, int64_t p2,
                                     Error **p3) {
  struct object_property_set_int_params params;
...
static void object_property_set_uint_worker(void *opaque) {
  struct object_property_set_uint_params *params =
      (struct object_property_set_uint_params *)opaque;
  object_property_set_uint(params->p0, params->p1, params->p2, params->p3);
}

void object_property_set_uint_wrapper(Object *p0, const char *p1, uint64_t p2,
                                      Error **p3) {
  struct object_property_set_uint_params params;
...
void memory_region_add_subregion_wrapper(MemoryRegion *p0, hwaddr p1,
                                         MemoryRegion *p2) {
  bool was_locked = qemu_mutex_iothread_locked();
  if (!was_locked) {
    qemu_mutex_lock_iothread();
...
MemTxResult memory_region_dispatch_read_wrapper(MemoryRegion *p0, hwaddr p1,
                                                uint64_t *p2, unsigned int p3,
                                                MemTxAttrs p4) {
  bool was_locked = qemu_mutex_iothread_locked();
  if (!was_locked) {
    qemu_mutex_lock_iothread();
...
MemTxResult memory_region_dispatch_write_wrapper(MemoryRegion *p0, hwaddr p1,
                                                 uint64_t p2, unsigned int p3,
                                                 MemTxAttrs p4) {
  bool was_locked = qemu_mutex_iothread_locked();
  if (!was_locked) {
...
static void gdbserver_start_worker(void *opaque) {
  struct gdbserver_start_params *params =
      (struct gdbserver_start_params *)opaque;
