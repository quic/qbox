...
typedef void (*object_property_set_str_fn)(QemuObject *, const char *,
                                           const char *, QemuError **);
typedef void (*object_property_set_link_fn)(QemuObject *, const char *,
                                            QemuObject *, QemuError **);
typedef void (*object_property_set_bool_fn)(QemuObject *, const char *, bool,
                                            QemuError **);
typedef void (*object_property_set_int_fn)(QemuObject *, const char *, int64_t,
                                           QemuError **);
typedef void (*object_property_set_uint_fn)(QemuObject *, const char *,
                                            uint64_t, QemuError **);
typedef void (*object_property_add_child_fn)(QemuObject *, const char *,
                                             QemuObject *);
typedef QemuObject *(*object_get_root_fn)(void);
typedef QemuMemoryRegion *(*memory_region_new_fn)(void);
typedef void (*memory_region_init_io_fn)(QemuMemoryRegion *, QemuObject *,
                                         const QemuMemoryRegionOps *, void *,
                                         const char *, uint64_t);
typedef void (*memory_region_init_ram_ptr_fn)(QemuMemoryRegion *, QemuObject *,
                                              const char *, uint64_t, void *);
typedef void (*memory_region_init_alias_fn)(QemuMemoryRegion *, QemuObject *,
                                            const char *, QemuMemoryRegion *,
                                            hwaddr, uint64_t);
typedef void (*memory_region_add_subregion_fn)(QemuMemoryRegion *, hwaddr,
                                               QemuMemoryRegion *);
typedef void (*memory_region_del_subregion_fn)(QemuMemoryRegion *,
                                               QemuMemoryRegion *);
typedef MemTxResult (*memory_region_dispatch_read_fn)(QemuMemoryRegion *,
                                                      hwaddr, uint64_t *,
                                                      unsigned int, MemTxAttrs);
typedef MemTxResult (*memory_region_dispatch_write_fn)(QemuMemoryRegion *,
                                                       hwaddr, uint64_t,
                                                       unsigned int,
                                                       MemTxAttrs);
...
typedef void (*qdev_connect_gpio_out_named_fn)(QemuDevice *, const char *, int,
                                               QemuGpio *);
...
typedef void (*async_safe_run_on_cpu_fn)(QemuObject *, void (*)(void *),
                                         void *);
