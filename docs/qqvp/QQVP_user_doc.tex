...
\begin{lstlisting}[language=bash]
    ...
    # apt install -y make build-essential cmake g++ wget flex bison unzip \
                     ...
                     libgtk-3-dev libsdl2-dev libzip-dev
\end{lstlisting}
\normalsize
...
\item Install the build dependencies:
	...
	\begin{lstlisting}[language=bash]
	    # brew install cmake libelf flex bison make pkg-config python \
                           ninja glib pixman sdl2 gtk+3 libzip
	\end{lstlisting}
	\normalsize
...
Any extra non-option arguments, that is, arguments not prefixed with '-' or '-{}-'
...
The following is an excerpt from the relevant {\small{\lstinline!load!}} section. For an unabridged example, see {\color{blue}{\url{https://git.codelinaro.org/clo/private/qqvp/qqvp/-/blob/875f7dce96930fda907ff4293c8b05771e828cdf/configs/fw/8775/SA8775P_conf.lua}}}.
...
applications, dependencies, building and testing: {\color{blue}{\url{https://github.com/kpet/clvk#readme}}}.
...
Using {\small{\lstinline!llvmpipe!}} as Vulkan driver you should expect an
