...
public:
    QemuCpuSifiveX280(const sc_core::sc_module_name& name, QemuInstance& inst, const char* model,
                      uint64_t hartid)
    ...
    void before_end_of_elaboration() {
        ...
        cpu.set_mip_update_callback(
            std::bind(&QemuCpuSifiveX280::mip_update_cb, this, std::placeholders::_1));
    }
