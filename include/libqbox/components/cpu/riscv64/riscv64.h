...
public:
    QemuCpuRiscv64(const sc_core::sc_module_name &name,
    ...
    void before_end_of_elaboration()
    {
        ...
        cpu.set_mip_update_callback(std::bind(&QemuCpuRiscv64::mip_update_cb,
...
public:
    QemuCpuRiscv64Rv64(const sc_core::sc_module_name &n,
                       QemuInstance &inst, uint64_t hartid)
