...
#define ARRAY_FIELD_EX64(regs, reg, field) FIELD_EX64((regs)[R_##reg], reg, field)
...
#define FIELD_DP8(storage, reg, field, val)                                                     \
    ({                                                                                          \
        ...
        uint8_t _d;                                                                             \
        _d = deposit32((storage), R_##reg##_##field##_SHIFT, R_##reg##_##field##_LENGTH, _v.v); \
        _d;                                                                                     \
    })
...
#define FIELD_DP64(storage, reg, field, val)                                                    \
    ({                                                                                          \
        ...
        uint64_t _d;                                                                            \
        _d = deposit64((storage), R_##reg##_##field##_SHIFT, R_##reg##_##field##_LENGTH, _v.v); \
        _d;                                                                                     \
    })
