...
public:
    bool operator==(const MACAddress& other) const { return memcmp(m_bytes, other.m_bytes, 6) == 0; }

    bool operator!=(const MACAddress& other) const { return !this->operator==(other); }
