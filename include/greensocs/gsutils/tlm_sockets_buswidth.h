...
class TLMBUSWIDTHBridge : public sc_core::sc_module
{
    SCP_LOGGER();

    using MOD = TLMBUSWIDTHBridge<INPUT_BUSWIDTH, OUTPUT_BUSWIDTH>;
...
typedef gs::TLMBUSWIDTHBridge<32, 64> TLMBUSWIDTHBridgeFrom32To64;
typedef gs::TLMBUSWIDTHBridge<64, 32> TLMBUSWIDTHBridgeFrom64To32;
GSC_MODULE_REGISTER(TLMBUSWIDTHBridgeFrom32To64);
GSC_MODULE_REGISTER(TLMBUSWIDTHBridgeFrom64To32);
#endif
