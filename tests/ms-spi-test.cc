...
TEST_BENCH(TestSpi, SpiWrite)
{
    ...
    cout<< endl<<"*****[EXCHANGE PROCESS(Dual same length)-1]*****"<<endl;
    ...
    cout<< endl<<"*****[EXCHANGE PROCESS(Dual same length)-2]*****"<<endl;
    ...
    cout<< endl<<"*****[EXCHANGE PROCESS(Dual not same length)-3]*****"<<endl;
