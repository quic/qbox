...
public:
    ...
    One(const sc_core::sc_module_name& n, int _thing = 0)
...
int sc_main(int argc, char* argv[])
{
  ...
  m_broker->set_preset_cci_value(
      "top.one.thing", cci::cci_value(cci::cci_value::from_json("30")),
      m_originator);
  m_broker->set_preset_cci_value(
      "top.two.thing", cci::cci_value(cci::cci_value::from_json("40")),
      m_originator);
