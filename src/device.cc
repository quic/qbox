...
void Device::connect_gpio_out(int idx, Gpio gpio)
{
    ...
    m_exports->qdev_connect_gpio_out(qemu_dev, idx, qemu_gpio);
}
...
void Device::connect_gpio_out_named(const char *n, int idx, Gpio gpio)
{
    ...
    m_exports->qdev_connect_gpio_out_named(qemu_dev, n, idx, qemu_gpio);
}
...
Gpio Device::get_gpio_in(int idx)
{
    ...
    qemu_gpio = m_exports->qdev_get_gpio_in(qemu_dev, idx);
    Object obj(reinterpret_cast<QemuObject *>(qemu_gpio), *m_exports);
...
Gpio Device::get_gpio_in_named(const char *name, int idx)
{
    ...
    qemu_gpio = m_exports->qdev_get_gpio_in_named(qemu_dev, name, idx);
    Object obj(reinterpret_cast<QemuObject *>(qemu_gpio), *m_exports);
