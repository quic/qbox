...
class cpu_arm_neoverseN2 : public QemuCpuArm
{
protected:
...
public:
    ...
    cpu_arm_neoverseN2(const sc_core::sc_module_name& name, sc_core::sc_object* o)
        : cpu_arm_neoverseN2(name, *(dynamic_cast<QemuInstance*>(o)))
    {
    }
    cpu_arm_neoverseN2(sc_core::sc_module_name name, QemuInstance& inst)
        : QemuCpuArm(name, inst, "neoverse-n2-arm")
