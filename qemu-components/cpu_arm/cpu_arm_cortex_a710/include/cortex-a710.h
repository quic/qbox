...
class cpu_arm_cortexA710 : public QemuCpuArm
{
protected:
...
public:
    ...
    cpu_arm_cortexA710(const sc_core::sc_module_name& name, sc_core::sc_object* o)
        : cpu_arm_cortexA710(name, *(dynamic_cast<QemuInstance*>(o)))
    {
    }
    cpu_arm_cortexA710(const sc_core::sc_module_name& name, QemuInstance& inst)
        : QemuCpuArm(name, inst, "cortex-a710-arm")
