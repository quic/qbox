...
class cpu_arm_cortexA76 : public QemuCpuArm
{
protected:
...
public:
    ...
    cpu_arm_cortexA76(const sc_core::sc_module_name& name, sc_core::sc_object* o)
        : cpu_arm_cortexA76(name, *(dynamic_cast<QemuInstance*>(o)))
    {
    }
    cpu_arm_cortexA76(const sc_core::sc_module_name& name, QemuInstance& inst)
