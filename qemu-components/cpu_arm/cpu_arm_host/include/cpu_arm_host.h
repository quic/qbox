...
class cpu_arm_host : public QemuCpuArm
{
protected:
...
public:
    ...
    cpu_arm_host(const sc_core::sc_module_name& name, sc_core::sc_object* o)
        : cpu_arm_host(name, *(dynamic_cast<QemuInstance*>(o)))
    {
    }
    cpu_arm_host(const sc_core::sc_module_name& name, QemuInstance& inst)
        : QemuCpuArm(name, inst, "host-arm")
