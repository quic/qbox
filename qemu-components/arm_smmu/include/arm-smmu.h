...
class arm_smmu : public QemuDevice, public QemuInitiatorIface
{
...
public:
    ...
    arm_smmu(const sc_core::sc_module_name& name, sc_core::sc_object* o)
        : arm_smmu(name, *(dynamic_cast<QemuInstance*>(o)))
    {
    }
    arm_smmu(sc_core::sc_module_name nm, QemuInstance& inst)
