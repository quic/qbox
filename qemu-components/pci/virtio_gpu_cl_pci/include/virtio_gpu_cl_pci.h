...
#ifndef _LIBQBOX_COMPONENTS_VIRTIO_GPU_CL_PCI_H
#define _LIBQBOX_COMPONENTS_VIRTIO_GPU_CL_PCI_H

#include <module_factory_registery.h>

#include <virtio_gpu.h>

class virtio_gpu_cl_pci : public QemuVirtioGpu
{
...
#endif // _LIBQBOX_COMPONENTS_VIRTIO_GPU_CL_PCI_H
